import { Briefcase, Code2, Download, GraduationCap, Mail, MapPin, User } from "lucide-react"
import "./about.css"
...
function About() {
  ...
  const download = ()=> {
    alert("On Progressing to download")
  }
  const contact = ()=> {
    alert("You are contact with me.")
  }
  return (
        ...
        <div className="profile-card">
          <div className="profile-header">
            ...
            <div className="profile-buttons">
              ...
              <button onClick={download} className="profile-button">
        ...
        <div className="main-content">
          <div className="tabs">
            <div className="tabs-list">
              <button onClick={() => setTab1('about-me')} className="tab-button  active" data-tab="about">
                <User className="tab-icon" />
                About Me
              </button>
              <button onClick={() => setTab1('experience')} className="tab-button active " data-tab="experience">
                <Briefcase className="tab-icon" />
                Experience
              </button>
              <button onClick={() => setTab1('education')} className="tab-button active " data-tab="education">
            ...
            {tab1 === "about-me" ? (
              <div className="tab-content active" id="about-tab">
                ...
                <div className="about-text">
                  <p>
                    Hello! I'm Basit Ahmadzai Web Developer with 5 years of experience specializing in front-end technologies. I
                    enjoy tackling complex problems and turning them into simple, beautiful solutions.
                
                    My journey in Computer Science began when I first discovered the power of creating on the web. It was
                  ...
                  <p>
                    ...
                    specialize in creating responsive, accessible, and performant web applications that deliver exceptional
                    user experiences. My expertise includes modern JavaScript frameworks, CSS architecture, and building
                ...
                <div className="timeline">
                  ...
                  <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                      ...
                      <p className="timeline-description">
                        Developed responsive websites and applications, collaborated with the design team, and implemented
